        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Connecting pet owners with trusted care providers since 2024.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/safety" className="text-sm text-muted-foreground hover:text-foreground">Safety</Link></li>
